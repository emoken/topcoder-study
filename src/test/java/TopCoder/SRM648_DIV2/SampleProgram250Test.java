...
public class SampleProgram250Test{
  ...
  private void doTest(int testNo) throws IOException {
    ...
    try {
      KitayutaMart2 target = new KitayutaMart2();
      ...
      for(Method m: methods){
        if(Modifier.PUBLIC == m.getModifiers() && m.getName().equals(METHOD_NAME)){
          ...
          answerVal = ((Integer) m.invoke(target, inStr1, inStr2)).intValue();

...
import TopCoder.SRM648_DIV2.SampleProgram1000;
import util.TestUtil;

public class SampleProgram100Test{

  private final String TEST_NAME = "SRM646_DIV2";
  private final String PROBLEM_NAME = "1000";
  private final String METHOD_NAME = "sampleMethod";
  ...
  private void doTest(int testNo) throws IOException {
    ...
    try {
      SampleProgram1000 target = new SampleProgram1000();
      ...
      for(Method m: methods){
        if(Modifier.PUBLIC == m.getModifiers() && m.getName().equals(METHOD_NAME)){
          ...
          answerVal = ((Integer) m.invoke(target, inIntArray)).intValue();

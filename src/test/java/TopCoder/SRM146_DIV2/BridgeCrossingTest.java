...
import TopCoder.SRM146_DIV2.BridgeCrossing;
import util.TestUtil;

public class BridgeCrossingTest{

  private final String TEST_NAME = "SRM146_DIV2";
  private final String PROBLEM_NAME = "1000";
  private final String METHOD_NAME = "minTime";
...
//  @Test
  ...
  private void doTest(int testNo) throws IOException {
    ...
    try {
      BridgeCrossing target = new BridgeCrossing();

...
public class FixedDiceGameDiv2 {
	...
	public double getExpectation(int a, int b){
		...
		double numOfWinningExperiments=0;
		...
		for(int i=a;i>0;i--){
			...
			while(true){
				...
				if(i > targetNum && targetNum > 0){
					numOfWinningExperiments++;
		...
		if(numOfWinningExperiments == 0){
			return 0;
		}else{
			return totalNumbers/numOfWinningExperiments;
		}
	}
	
	public static void main(String[] args) {
		System.out.print(new FixedDiceGameDiv2().getExpectation(Integer.parseInt(args[0]),Integer.parseInt(args[1])));
	}
}
...
//You are given the ints a and b. The players already rolled their dice. 
//You do not know what numbers they rolled, but you know that Alice won the game. Compute and return the expected value of the number Alice rolled.
//Definition
//
//Class:
//FixedDiceGameDiv2
...
//-
//The expected value can be seen as the average of many experiments. 
//In our case, suppose that you folow a lot of games, and each time Alice wins, you write down her score. 
//As you watch more and more games, the average of all numbers you have written down will converge to the expected value you should return.
//Constraints
//-
